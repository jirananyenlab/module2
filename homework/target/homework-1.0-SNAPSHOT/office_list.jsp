...
<head>
    ...
    <script>
        function clickDiv(officeCode , itemID ) {
            const selectDelete = document.querySelectorAll(".selectDelete");
            for (const item of selectDelete) {
                if (item.matches("#item"+itemID)) {
            ...
            xhttp.open("GET", "delete-office?officeCode=" + officeCode );
            xhttp.send();
           }
          }
        }
...
<div class="grid-container" id="myBtn">
    ...
    <div class="grid-item">
        <h3>update</h3>
            ...
            <input type="submit" value="update" class="submit1" ${selectUpdate.officeCode == null ? "disabled"  : ""}>
        </form>
    </div>
    <div class="grid-item">
